...
<?php msg_alert(); ?> 
    ...
    <form method="post" action="<?php echo current_url()?>"  class="validation form-horizontal" />   
          ...
          <div class="form-group"><label class="col-md-3 control-label">Color Name</label>
            <div class="col-md-9">
                <input type="type" class="form-control" placeholder="Color Name" name="color_name" value="<?php if(!empty($color_attributes->color_name)){ echo $color_attributes->color_name; }else{ echo set_value('color_name'); } ?>"/>
