...
<?php msg_alert(); ?>
    ...
    <form method="post" action="<?php echo current_url()?>"  class="validation form-horizontal" />
        ...
        <div class="form-group"><label class="col-md-3 control-label">Courier Name</label>
            <div class="col-md-9">
                <input type="type" class="form-control" placeholder="Courier Name" name="courier_name" value="<?php if(!empty($couriers->courier_name)){ echo $couriers->courier_name; }else{ echo set_value('courier_name'); } ?>" />
