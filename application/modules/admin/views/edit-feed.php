...
<div class="clear" style="margin-bottom: 10px;"></div>
    ...
    <div class="col-lg-9 animated fadeInRight">
            ...
            <?php 
                ...
                echo form_open('admin/feedUpdate/'.$feed->id, $attributes); 
            ?>
                <div class="mail-box">
                    
<!--                    <textarea class="form-control" style="white-space: pre-wrap"><?php echo $feed->content;?></textarea> -->
                    <?php 
...
<!--                    <a class="btn btn-sm btn-white" href="<?php echo $feed->id;?>"><i class="fa fa-check text-navy"></i> Update</a>-->
                </div>
