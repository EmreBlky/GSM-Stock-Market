...
<div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>Edit listing category</strong>
        </li>
    </ol>
</div>
<div class="col-lg-2">
    ...
    <form method="post" action="<?php echo current_url()?>"  class="validation form-horizontal" />
          ...
          <div class="form-group"><label class="col-md-3 control-label">Parent Category</label>
            ...
            <select name="parent_id"  class="form-control">
                ...
                <option value="<?php echo $row->id ?>" <?php if(!empty($_POST['parent_id']) && $_POST['parent_id']==$listing_categories->parent_id) echo 'selected="selected"'; ?>><?php echo $row->category_name ?></option>
                <?php endforeach ?>
                <?php endif ?>
            </select>
