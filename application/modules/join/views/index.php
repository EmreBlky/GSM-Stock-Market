            ...
            <div class="ibox float-e-margins">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="checkbox i-checks"><input type="checkbox" value="terms" name="terms" id="terms" required><label> You agree to create a free business profile account under Bronze Membership, no charges will be invoiced to you by GSMStockMarket.com Limited.</label></div>
                    </div>
                    <div class="col-md-3">
