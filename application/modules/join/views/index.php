...
//                    echo "</pre>";
                                ...
                                <select class="form-control m-b" id="bprimary" name="bprimary" style="float:left" onchange="updateSelects1(this.value)">
                                    ...
                                    if (isset($company->business_sector_1)) {
                                        foreach ($SelectedBiz As $SelectedBizOne) {
                                            ?>
                                            <option  value="<?php echo $SelectedBizOne; ?>" <?php echo (isset($SelectedBizOne) && ($SelectedBizOne == $company->business_sector_1)) ? ' selected="selected"' : ''; ?> ><?php echo $SelectedBizOne; ?></option>
                                            <?php
                                        }
                                        ?>
                            ...
                            <div id="secondary-business">
                                ...
                                <select class="form-control m-b" name="bsecondary" id="bsecondary" style="float:left" onchange="updateSelects2(this.value)">
                                    ...
                                    if (isset($company->business_sector_2)) {
                                        foreach ($SelectedBiz As $SelectedBizOne) {
                                            ?>
                                            <option value="<?php echo $SelectedBizOne; ?>" <?php echo isset($SelectedBizOne) && ($SelectedBizOne == $company->business_sector_2) ? ' selected="selected"' : ''; ?> ><?php echo $SelectedBizOne; ?></option>
                                            <?php
                                        }
                                    } else {
                                        ?>
                            ...
                            <div id="tertiary-business">
                                ...
                                <select class="form-control m-b" name="btertiary" id="btertiary" style="float:left" onchange="updateSelects3(this.value)">
                                    ...
                                    if (isset($company->business_sector_3)) {
                                        foreach ($SelectedBiz As $SelectedBizOne) {
                                            ?>
                                            <option  value="<?php echo $SelectedBizOne; ?>" <?php echo isset($SelectedBizOne) && ($SelectedBizOne == $company->business_sector_3) ? ' selected="selected"' : ''; ?> ><?php echo $SelectedBizOne; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" rows="5" id="companybio" name="company_profile"></textarea>
                            <div id="charNum"></div>
                        </div>  
                    </div>
