  ...
  <div class="row">
    <div style="margin-bottom:30px;text-align:center"><img src="public/main/template/gsm/images/gsm.png"></div>
      ...
      <div class="col-lg-6 col-lg-offset-3">
        <div class="ibox">
          <div class="ibox-title"><h5>Order Cancelled</h5></div>
        	
          <div class="ibox-content" style="padding-bottom:5px">
          	<p>We are sorry that you have cancelled your order. If you are not redirected automatically back to the website click the button below to return.</p>
