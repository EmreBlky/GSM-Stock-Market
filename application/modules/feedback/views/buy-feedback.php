              ...
              <div class="modal-content">
                  ...
                  <form>
                    ...
                    <div class="form-group" style="margin-top:15px">
                        ...
                        <div class="col-md-6">
                            <input class="description-rating" id="description-rating_<?php echo $order_id; ?>">
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:15px">
    ...
    jQuery(document).ready(function () {
        ...
        $('#description-rating_' + id +'').rating({'showCaption':true, 'stars':'5', 'min':'0', 'max':'5', 'step':'1', 'size':'xs', 'starCaptions': {0:'Very inaccurate', 1:'Very inaccurate', 2:'Inaccurate', 3:'Neither inaccurate nor accurate', 4:'Accurate', 5:'Very accurate'}});
        ...
        $(document).on('click', '#submit_message_' + id +'', function(event) {
            ...
            var rateDesc        = $('#description-rating_' + id +'').val();
