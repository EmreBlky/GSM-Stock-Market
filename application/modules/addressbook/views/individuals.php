            ...
            <div class="col-lg-4"><!-- Profile Widget Start -->
                <div class="contact-box">
                    ...
                    <div class="col-sm-8 profile-minh">
                        ...
                        <h4 style="margin:15px 0 0 0"><strong>TebiHost Limited</strong></h4>
                    ...
                    <div class="col-sm-12 gsm-contact">
                            ...
                            <button class="btn btn-profile" type="button"><i class="fa fa-user"></i>&nbsp;View Profile</button>
                            </div>
                    </div>
            ...
            <div class="col-lg-4"><!-- Profile Widget Start -->
                <div class="contact-box">
                    ...
                    <div class="col-sm-8 profile-minh">
                        ...
                        <h4 style="margin:15px 0 0 0"><strong>GSMStockMarket.com Limited</strong></h4>
                        <ul style="list-style:none;padding:0">
                        	<li>Mobile Repair</li>
                            <li>Network Operator</li>
                            <li>Insurance</li>
