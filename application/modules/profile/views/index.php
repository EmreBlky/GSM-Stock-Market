                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5" id="cluster_info">
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="button" class="btn btn-primary" id="showtoast">Popup Test</button>
  ...
  $(document).ready(function() {
	...
	Command: toastr[success]("Hi, welcome to Inspinia. This is example of Toastr notification box.")
