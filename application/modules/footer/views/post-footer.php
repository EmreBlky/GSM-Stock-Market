<!-- Mainly scripts -->
    ...
    <!-- Jvectormap -->
    <script src="/public/main/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/public/main/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
