        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . "marketplace/payment_confirm/"; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <div class="row">
                        <label><input type="checkbox" name="payment_confirm" required> Yes Payment received successfully.</label>
                    ...
                    <div class="row">
                        ...
                        <input type="file" id="tracking_file" name="tracking_file" class="btn default btn-file valid"></div>
