    ...
    <div class="ibox float-e-margins">
        ...
        <?php if(!empty($counter_offer)): ?>
            ...
            <tr>
                ...
                <a onclick="view_offer(<?php echo $value->id; ?>)" class="btn btn-info" style="font-size:10px" data-toggle="modal" data-target="#view_offers"><i class="fa fa-paste"></i> View Offer </a>
                </th>
            </tr>
