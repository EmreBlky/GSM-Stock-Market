        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <button class="btn btn-info" type="button" style="font-size:10px" data-toggle="modal" data-target="#offers"><i class="fa fa-paste"></i> View Offer </button>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center"><span class="label label-info">Offers Waiting (3)</span></td>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <tr>
                        <td style="text-align:center"><span class="label label-primary">Active</span></td>
                        <td>17:22 11-02</td>
                        <td>Apple iPhone 4S 16GB</td>
                        <td>Refurbished</td>
                        <td data-toggle="tooltip" data-placement="left" title="t">GBP 154.02</td>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        <td style="text-align:center"><span class="label label-info">Offers Waiting (4)</span></td>
                        <td>17:22 11-02</td>
                        <td>Apple iPhone 4S 16GB</td>
                        <td>Refurbished</td>
                        <td data-toggle="tooltip" data-placement="left" title="t">GBP 154.02</td>
                    ...
                    <tr>
                        <td style="text-align:center"><span class="label label-info">Offers Waiting (6)</span></td>
                        <td>17:22 11-02</td>
                        <td>Apple iPhone 4S 16GB</td>
                        <td>Refurbished</td>
                        <td data-toggle="tooltip" data-placement="left" title="t">GBP 154.02</td>
