        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                    ...
                    <div class="btn-group pull-right" style="padding-left: 10px;">
                        ...
                        <button onclick="window.location.href='mailbox/draft/<?php echo $previous;?>'" class="btn btn-white btn-sm"><i class="fa fa-arrow-left"></i> Previous</button>
                        <?php }?>
                        <?php if($end_email != $mess_id){ ?>
                        <button onclick="window.location.href='mailbox/draft/<?php echo $next;?>'" class="btn btn-white btn-sm">Next <i class="fa fa-arrow-right"></i></button>
                        <?php }?>                        
                    </div>
                    ...
                    <div class="btn-group pull-right" style="padding-left: 10px;">
                        ...
                        <button onclick="window.location.href='mailbox/draft/<?php echo $start_email;?>'" class="btn btn-white btn-sm">Next <i class="fa fa-arrow-right"></i></button>
                        <?php }?>
                        <?php if($mess_id != $end_email){?>
                        <button onclick="window.location.href='mailbox/draft/<?php echo $end_email;?>'" class="btn btn-white btn-sm"><i class="fa fa-arrow-left"></i> Previous</button>
                        <?php }?>
                    </div>
                    <?php }?>
