            ...
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    ...
                    <div class="btn-group pull-right" style="padding-left: 10px;">
                        ...
                        <button onclick="window.location.href='mailbox/archive/<?php echo $next;?>'" class="btn btn-white btn-sm"><i class="fa fa-arrow-left"></i> Previous</button>
                        <?php }?>
                        <?php if($start_email != $mess_id){ ?>
                        <button onclick="window.location.href='mailbox/archive/<?php echo $previous;?>'" class="btn btn-white btn-sm">Next <i class="fa fa-arrow-right"></i></button>
                        <?php }?>
                    </div>
                    ...
                    <div class="btn-group pull-right" style="padding-left: 10px;">
                        ...
                        <button onclick="window.location.href='mailbox/archive/<?php echo $start_email;?>'" class="btn btn-white btn-sm"><i class="fa fa-arrow-left"></i> Previous</button>
                        <?php }?>
                        <?php if($mess_id != $end_email){?>
                        <button onclick="window.location.href='mailbox/archive/<?php echo $end_email;?>'" class="btn btn-white btn-sm">Next <i class="fa fa-arrow-right"></i></button>
                        <?php }?>
                    </div>
                    <?php }?>
