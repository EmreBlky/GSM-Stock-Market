...
//                                        'mobile'    => $this->input->post('mobile'),
    ...
    {
        $val_code = $this->member_model->_custom_query_count("SELECT COUNT(*) AS count FROM members WHERE validation_code = '".$vcode."'");
        
        if($val_code[0]->count > 0){
            ...
            $data_mail = array(
                                    ...
                                    'body'              => 'Thank you for signing up to GSMStockMarket.com<br /><br/>Your account is now active. To get started head over to <strong>My Profile > Edit Profile</strong> and complete your profile so other users will be able to search and find your company.<br /><br/>With bronze access you will receive the following:<br />- View and edit your own profile<br />- Check out who has viewed your profile<br />- Reply to members who contact you via the mailbox system<br />- Add users to your address book/favourites<br /><br />To have full access to our platform and have your account verified we require that you submit two (2) trade references. Once submitted the two users will be emailed and sent a form to complete regarding your previous business.<br />When we are satisfied with the quality of the trade references we will credit check your company and will then give you complete access to our website.<br /><br />If you have any issues using our website feel free to contact us through the submit a ticket system under the support tab. <br /><br />if you also experience any issues browsing/using the website or would like to have any features added then let us know! We would love to hear from you, just submit a feedback ticket and we will do our best to help you out.<br /><br />Kind Regards,<br />GSMStockMarket.com Team',
                                    'inbox'             => 'yes',
                                    'sent'              => 'yes',
                                    'date'              => date('d-m-Y'),
                                    'time'              => date('H:i'),
            ...
            $email_body = '<table class="body-wrap" style="margin: 0;padding: 0;font-family: &quot;Helvetica Neue&quot;, &quot;Helvetica&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;font-size: 14px;background-color: #f6f6f6;width: 100%;">
                            ...
                            </p><p style="margin: 0;padding: 0;font-family: &quot;Helvetica Neue&quot;, &quot;Helvetica&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;font-size: 14px;margin-bottom: 10px;font-weight: normal;">Although your account is activated you are still unable to view our trading platform completely! We only allow verified members on our platform and to become verified you will need to login to your account and submit two (2) trade references and we will then verify your account once the trade references have been confirmed and we have credit checked your company.</p>
                            </td>
                            </tr>
                            <tr style="margin: 0;padding: 0;font-family: &quot;Helvetica Neue&quot;, &quot;Helvetica&quot;, Helvetica, Arial, sans-serif;box-sizing: border-box;font-size: 14px;">
            ...
            redirect('register/validation_error');
    ...
    {
        $data['base'] = $this->config->item('base_url');
        $this->load->view('validation-error', $data);
    }
