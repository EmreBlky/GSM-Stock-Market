...
$active_record = TRUE;
 ...
 elseif($base_url == 'localhost/secure.gsmstockmarket.com/'){
  ...
  elseif($baseSSL_url == 'secure.gsmstockmarket.com/'){
    ...
    $db['default']['autoinit'] = TRUE;
    $db['default']['stricton'] = FALSE;
  }elseif($base_url == 'localhost/gsm-secure-dev/'){
    
  //DEVELOPMENT DATABASE:
  $db['default']['hostname'] = 'localhost';
  $db['default']['username'] = 'root';
  $db['default']['password'] = '';
  $db['default']['database'] = 'gsm-secure-dev';
  $db['default']['dbdriver'] = 'mysql';
  $db['default']['dbprefix'] = '';
  $db['default']['pconnect'] = TRUE;
  $db['default']['db_debug'] = TRUE;
 ...
 elseif($base_url == 'secure-staging.gsmstockmarket.com/'){
 ...
 else //NAVEED: LOCAL DATABASE:
 {

    $db['default']['hostname'] = 'localhost';
    $db['default']['username'] = 'root';
    $db['default']['password'] = '';
    $db['default']['database'] = 'deviousd_gsmdev';
    $db['default']['dbdriver'] = 'mysql';
    $db['default']['dbprefix'] = '';
    $db['default']['pconnect'] = FALSE;
    $db['default']['db_debug'] = TRUE;
