...
class Paypal_subscribe {
	...
	********************************************/
	...
	//'------------------------------------
	var $API_UserName = "info_api1.gsmstockmarket.com";
	var $API_Password = "7BMBNRCY3UGH6NWE";
	var $API_Signature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AYktlzIS7LZVG9W3fGQEgkc-Icf2";
	...
	function GetShippingDetails($token)
	{
		...
		if($ack == "SUCCESS" || $ack=="SUCCESSWITHWARNING")
		{
                    ...
                    $payPaldata = array(
                                        ...
                                        'shipToCountry'  => $resArray["SHIPTOCOUNTRYCODE"]
                                );
                    $this->CI->session->set_userdata($payPaldata);
	...
	*/
	function ConfirmPayment( $FinalPaymentAmt )
	{
		...
		$paymentType 		= urlencode($this->CI->session->userdata('PaymentType'));
		$currencyCodeType 	= urlencode($this->CI->session->userdata('currencyCodeType'));
		$payerID 		= urlencode($this->CI->session->userdata('payer_id'));
		...
		$resArray = $this->hash_call("DoExpressCheckoutPayment",$nvpstr);
                 ...
                 $this->CI->session->set_userdata('billing_agreemenet_id', $resArray["BILLINGAGREEMENTID"]);
	...
	function hash_call($methodName,$nvpStr)
	{
	   ...
	   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
		...
		$nvpReqArray = $this->deformatNVP($nvpreq);
                ...
                $this->CI->session->set_userdata('nvpReqArray', $nvpReqArray);
