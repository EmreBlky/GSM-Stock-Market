...
class CI_Email {
	...
	var	$smtp_host		= "smtp.demon.co.uk";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "administrator@dipo1-adsl.demon.co.uk";		// SMTP Username
	var	$smtp_pass		= "Rwt189K7?2";		// SMTP Password
	...
	var     $crlf			= "";		// The RFC 2045 compliant CRLF for quoted-printable is "\r\n".  Apparently some servers,
